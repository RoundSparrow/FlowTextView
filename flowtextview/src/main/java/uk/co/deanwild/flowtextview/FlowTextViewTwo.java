 ...
 */
public class FlowTextViewTwo extends RelativeLayout {

    // FIELDS
    private final PaintHelper mPaintHelper = new PaintHelper();
    private final SpanParserTwo mSpanParser = new SpanParserTwo(this, mPaintHelper);
    private final ClickHandlerTwo mClickHandler = new ClickHandlerTwo(mSpanParser);
    ...
    public FlowTextViewTwo(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public FlowTextViewTwo(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public FlowTextViewTwo(Context context) {
        super(context);
        init(context, null);
    }
